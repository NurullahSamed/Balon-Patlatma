...
public class GameScreen  implements Screen {
    ...
    public GameScreen(final Main gam,boolean ses) {
        this.game = gam;
        this.ses = ses;
    ...
    public void render(float delta) {
        ...
        while (iter.hasNext() ) {
            ...
            //int secim = MathUtils.random(0, 1);
            kirmizi.y += 150f * Gdx.graphics.getDeltaTime();
            ...
            if(secim ==0 )
            {
                kirmizi.x -= MathUtils.random(0, 200) * Gdx.graphics.getDeltaTime();
            }
            if(secim == 1 )
            {
                //kirmizi.y += 150f* Gdx.graphics.getDeltaTime();
        ...
        while (iter3.hasNext()) {
            ...
            yesil.y += 300 * Gdx.graphics.getDeltaTime();
        ...
        while (iter4.hasNext()) {
            ...
            siyah.y += 300 * Gdx.graphics.getDeltaTime();
        ...
        if(sure == 0)
        {
            ...
            if(birYesil && birSari && birSiyah && birKirmizi && puan >=100 )  //Oyun başarılı
            {
                game.setScreen(new OyunBasarili(game,puan,ses));
            }

            else //Oyun Başarısız
            {
                game.setScreen(new OyunBitti(game,puan,ses));
