...
public class GameScreen3  implements Screen {
    ...
    public GameScreen3(final Main gam,long veri,long veri2,boolean ses) {
        this.game = gam;
        this.ses = ses;
        puan =veri;
        puan2 =veri2;
    ...
    public void render(float delta) {
        ...
        while (iter.hasNext() ) {
            ...
            kirmizi.y += 300f * Gdx.graphics.getDeltaTime();
        ...
        if(sure == 0)
        {
            ...
            if(birYesil && birSari && birSiyah && birKirmizi && puan3 >= 100 )  //Oyun başarılı
            {
                game.setScreen(new OyunBasarili3(game,puan,puan2,puan3,ses));
            }

            else //Oyun Başarısız
            {
                game.setScreen(new OyunBitti3(game,puan,puan2,puan3,ses));
