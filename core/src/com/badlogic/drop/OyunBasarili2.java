...
public class OyunBasarili2 implements Screen {
    ...
    public OyunBasarili2(final Main gam,long veri,long veri2,boolean ses) {
        game = gam;
        this.ses = ses;
        ...
        oyunbasarili = new Texture("oyunbasarili.png");
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, str, 365, 320);
        game.batch.end();
        ...
        if (Gdx.input.isTouched()) {
            ...
            {
                game.setScreen(new GameScreen3(game,puan,puan2,ses));
            }
        }
